...
const CardImg: CardImgProps = ({src, caption, width, height}) => {
    return (
        <div className={`relative flex-1 ${width || "lg:max-w-1/2"} ${height || "h-full"} overflow-hidden rounded-lg`}>
            <img src={src} className="w-full h-full object-cover transition duration-300 ease-in-out hover:scale-115" />
