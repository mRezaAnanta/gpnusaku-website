...
const CardProduct: CardProps = ({ title, description, timestamp}) => {
    return (
        <div className="flex flex-col gap-3 min-h-48 bg-gradient-to-b from-white via-white to-light-green rounded-lg p-6 shadow-xs hover:shadow-2xl transform duration-200 ease-in-out hover:-translate-y-0.5 hover:border-dark-green">
